...
(function($) {
  $.facebox = function(data, klass, settings) {
    ...
    defaultSettings: {
      opacity      : 0.18,
      overlay      : true,
      loadingImage : '/images/bg/facebox/loading.gif',
      closeImage   : '/images/bg/facebox/closelabel.gif',
      imageTypes   : [ 'png', 'jpg', 'jpeg', 'gif' ],
      faceboxHtml  : '<div id="facebox" style="display:none;"><div class="popup"><table><tbody><tr><td class="tl"/><td class="b"/><td class="tr"/></tr><tr><td class="b"/><td class="body"><div class="content"></div><div class="footer"><a href="#" class="close"><img src="/facebox/closelabel.gif" title="close" class="close_image" /></a></div></td><td class="b"/></tr><tr><td class="bl"/><td class="b"/><td class="br"/></tr></tbody></table></div></div>'
    },
    loading: function() {
      init();
    ...
    close: function() {$(document).trigger('close.facebox'); return false;}
  });
  ...
  $(document).bind('close.facebox', function() {
    ...
    $('#facebox').fadeOut(function() {$('#facebox .content').removeClass().addClass('content'); hideOverlay(); $('#facebox .loading').remove();});
  });
})(jQuery);